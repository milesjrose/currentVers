...
{'name': 'lovesBillGreg', 'RBs': [{'pred_name': 'lover', 'pred_sem': ['lover1', 'lover2', 'lover3'], 'higher_order': False, 'object_name': 'Bill', 'object_sem': ['bill1', 'bill2', 'bill3'], 'P': 'non_exist'}, {'pred_name': 'beloved', 'pred_sem': ['beloved1', 'beloved2', 'beloved3'], 'higher_order': False, 'object_name': 'Greg', 'object_sem': ['greg1', 'greg2', 'greg3'], 'P': 'non_exist'}], 'set': 'memory', 'analog': 0}]
